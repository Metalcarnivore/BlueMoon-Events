...
<div class="container-fluid">
    <form action="" id="manage-book">
        ...
        <div class="form-group">
			...
			<input type="text" class="form-control" name="event_name"  value="<?php echo isset($event_name) ? $event_name :'' ?>" required>
		</div>
		<div class="form-group">
			<label for="" class="control-label">Audience No:</label>
			<input type="text" class="form-control" name="audience"  value="<?php echo isset($audience) ? $audience :'' ?>" required>
		</div>
        <div class="form-group">
			<label for="" class="control-label">Amount</label>
			<input type="number" class="form-control" name="amount"  value="<?php echo isset($amount) ? $amount : 0 ?>" required>
		</div>
