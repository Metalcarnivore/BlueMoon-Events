				...
				<form action="" id="manage-event">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<input type="text" class="form-control" name="event"  value="<?php echo isset($event_name) ? $event_name :'' ?>" required>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
					...
					<div class="form-group row">
						<div class="col-md-5">
							...
							<input type="number" step="any" class="form-control text-right" name="audience_capacity" id ='audience_capacity'  value="<?php echo isset($audience) ? $audience : 0 ?>" required autocomplete="off">
						</div>
					</div>
					<div class="form-group row">
						<div class="col-md-5">
